...
$domicilis = ['Jakarta', 'Depok', 'Bogor', 'Tangerang', 'Bekasi', 'Lainnya'];
?>
...
<body>
    <div class='container'>
        <h2>Form Ragistrasi IT Club Data Science</h2>
        <hr>
                ...
                <div class="col-8">
                    <select id="prodi" name="prodi" class="custom-select" required="required">
                        <?php foreach ($majors as $major) : ?>
                            <option value="<?php echo $major ?>"><?php echo $major ?></option> <!--ini looping-->
                        <?php endforeach ?>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <select id="domisili" name="domisili" class="custom-select" required="required">
                        <?php foreach ($domicilis as $domicile) : ?>
